...
{
    resize(850, 550);
    setWindowTitle(tr("arcoin") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
    ...
    setObjectName("arcoinApp");
    //setStyleSheet("#arcoinApp { background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:1, stop:0 #757575, stop:1.0 #979797); } QToolTip { color: #efefef; background-color: #434343;  border:0px;} ");
    setStyleSheet("#arcoinApp { background-color: #B2B2B2; } QToolTip { color: #efefef; background-color: #434343;  border:0px;} ");
    ...
    statusBar()->setObjectName("arcoinStatusBar");
    statusBar()->setStyleSheet("#arcoinStatusBar { border-top-color: qlineargradient(spread:pad, x1:0, y1:0, x2:0, y2:1, stop:0 #292D30, stop:0.5 #696D70, stop:1.0 #696D70); border-top-width: 1px; border-top-style: inset; background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:0, y2:1, stop:0 #0A3050, stop:1.0 #070010); color: #b2b2b2; } QToolTip { color: #efefef; background-color: #434343; border:0px;}");
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a arcoin address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About arcoin"), this);
    aboutAction->setToolTip(tr("Show information about arcoin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for arcoin"));
...
void BitcoinGUI::createToolBars()
{
    ...
    toolbar->setStyleSheet("QToolButton { min-height:36px;color:#b2b2b2;border:none;margin:0px;padding:0px;} QToolButton:hover { color: #0899C9; background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:0, y2:1, stop:0 #0A3050, stop:1.0 #070010); margin:0px; padding:0px; border:none; } QToolButton:checked { color: #0899C9; background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:0, y2:1, stop:0 #0A3050, stop:1.0 #070010); margin:0px; padding:0px; border-right-color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:0 #3b3b3b, stop:0.5 #6c6c6f, stop:1.0 #6c6c6f);border-right-width:3px;border-right-style:inset; border-left-color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:0 #2a2a2a, stop:0.5 #5b5b5e, stop:1.0 #5b5b5e);border-left-width:2px;border-left-style:inset; } QToolButton:pressed { color: #0899C9; background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:0, y2:1, stop:0 #0A3050, stop:1.0 #070010); margin:0px; padding:0px; border:none;} QToolButton:selected { color: #ffffff; background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:0, y2:1, stop:0 #474748, stop:1.0 #353536); margin:0px;padding:0px;border:none; } #tabsToolbar { min-height:48px; color: #b2b2b2; background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:0, y2:1, stop:0 #4E7492, stop:1.0 #0A3050); margin:0px; padding:0px; border-top-color: rgba(160, 160, 160, 191); border-top-width: 1px; border-top-style: inset; } QToolBar::handle { background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:0, y2:1, stop:0 #4E7492, stop:1.0 #0A3050); }");
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("arcoin client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("arcoin client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to arcoin network.", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid arcoin address or malformed URI parameters."));
    }
