...
static const int64 MAX_MONEY = 1500000 * COIN;			// 1 Million + overhead
...
static const uint256 hashGenesisBlockOfficial("0x94e1a637f89a8e798f83e306449d1fd98cfeeadcf4331a231b6e2e427a09e844");
static const uint256 hashGenesisBlockTestNet ("0x94e1a637f89a8e798f83e306449d1fd98cfeeadcf4331a231b6e2e427a09e844");
...
public:
    ...
    {
        // arcoin: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64& nCoinAge) const;  // arcoin: get transaction coin age
...
public:
    ...
    // arcoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // arcoin: entropy bit for stake modifier if chosen by modifier
    ...
    // arcoin: two types of block: proof-of-work or proof-of-stake
    ...
    // arcoin: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64& nCoinAge) const; // arcoin: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    CBigNum bnChainTrust; // arcoin: trust score of block chain
    int nHeight;

    int64 nMint;
    int64 nMoneySupply;

    unsigned int nFlags;  // arcoin: block index flags
    enum  
    {
