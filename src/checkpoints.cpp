...
namespace Checkpoints
{
    ...
    // arcoin: get last synchronized checkpoint
    ...
    // arcoin: only descendant of current sync-checkpoint is allowed
    ...
    // arcoin: reset synchronized checkpoint to last hardened checkpoint
...
// arcoin: sync-checkpoint master key
...
// arcoin: verify signature of sync-checkpoint message
...
// arcoin: process synchronized checkpoint
